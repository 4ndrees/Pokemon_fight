...
URL_ATTACK_BASE = "https://www.pokexperto.net/index2.php?seccion=nds/nationaldex/movimientos_nivel&pk="
...
def get_pokemon(index):
    ...
    attacks_url = "{}{}".format(URL_ATTACK_BASE, index)

    pokemon_attacks_page = session.get(attacks_url)

    new_pokemon["attacks"] = []

    for attack_item in pokemon_attacks_page.html.find(".pkmain")[-1].find("tr .check3"):
        attack = {
